 ...
 * @param {req} req is the request of the user
 * @param {res} res is the response that will be send
 * @param {next} next to move to the route callback function
 * **/
middleware_functions.isAuthorized_comments = function (req, res, next) {
 ...
 *  this middleware is for checking if the user is have the right authorization to request a
 * put,delete,get operations.
 * @param {req} req the request of the user
 * @param {res} res the response that will be send
 * @param {next} next to move to the route callback function
 * **/
middleware_functions.isAuthorized_campgrounds = function (req, res, next) {
...
middleware_functions.isLoggedIn = function (req, res, next) {
	if (req.isAuthenticated()) {
